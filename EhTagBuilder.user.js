...
(function() {
    ...
    var buttonInserPlace = document.querySelector(".pagehead-actions")||document.createElement('div'); //按钮插入位置
    var windowInserPlace = document.querySelector(".reponav")||document.createElement('div'); //窗口插入位置
