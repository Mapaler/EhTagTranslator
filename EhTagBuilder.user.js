...
(function(){
    ...
    var EhTagBuilder = (function() {
        ...
        var windowInserPlace = document.querySelector(".reponav")||document.querySelector("#nb"); //窗口插入位置
...
#nb .select-menu button:hover {
    color: #FFFBDB;
}
#nb .select-menu .select-menu-modal-holder{
    display: none;
    position: absolute;
    left: 0;
    top:20px;
...
#nb .select-menu:hover>.select-menu-modal-holder{
    display: block;
}
#nb .select-menu button img{
    filter:invert(1) grayscale(1) opacity(.8);
}
#nb .select-menu .js-menu-close{
    display: none;
}


p#nb .select-menu img{
    width: auto;
    height:auto;
    margin: 0;
}
p#nb .select-menu .select-menu-item-icon {
    margin: 0;
    height: 16px;
    width: auto;
    float: left;
...
/*.select-menu-modal-holder.js-navigation-container{*/
    /*padding: 16px;*/
    /*position: absolute;*/
    /*left: 0;*/
    /*top: 0;*/
...
.ido .select-menu-modal-holder ,.gm .select-menu-modal-holder ,.stuffbox .select-menu-modal-holder ,#m .select-menu-modal-holder{
    position: absolute;
    top: 16px;
    right: 16px;
    z-index: 999999999;
...
.select-menu-item:hover svg.select-menu-item-icon{
    filter:invert(1);
}`);
                    ...
                    [
                        buildMenuList([
                            buildMenuItem("CSS文本",
                                ...
                                ,buildSVG("css")),
                            // buildMenuItem("保存",null,buildSVG("check"),function(){
                            //     GM_setValue('EhTagTranslatorCss',css);
                            //     var css_output_w = document.querySelector("#ETB_css-output");
